...
def main(data_dirs, outputdir, good):
    ...
    for data_dir in data_dirs:
        ...
        if len(qc_file) == 1:
            ...
            new_sample_dict = {inv_map[x['sample_name'].split('_')[0]] : x for x in csv.DictReader(open(qc_file[0]), dialect=csv.excel)  if x['sample_name'].split('_')[0] in good.values() }
...
if __name__ == '__main__':
    data_dirs = ['/home/ubuntu/transfer/incoming/QIB_Sequencing/Covid-19_Seq/result.illumina.20210709-Lebanon',
     '/home/ubuntu/transfer/incoming/QIB_Sequencing/Covid-19_Seq/result.illumina.20210716-Lebanon',
     '/home/ubuntu/transfer/incoming/QIB_Sequencing/Covid-19_Seq/result.illumina.20210721-Lebanon',
     '/home/ubuntu/transfer/incoming/QIB_Sequencing/Covid-19_Seq/result.illumina.20210729-Lebanon']
    outputdir = 'temp/leb-sub/file_locs.csv'
    gis_sub = 'temp/leb-sub/leb.gis.tsv'
    submitted = [x['covv_virus_name'].split('/')[2] for x in csv.DictReader(open(gis_sub), dialect=csv.excel_tab())] 
